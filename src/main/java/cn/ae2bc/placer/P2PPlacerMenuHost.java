...
public final class P2PPlacerMenuHost
        extends WirelessTerminalMenuHost<WirelessComponentPlacerItem> {
    ...
    public P2PPlacerMenuHost(WirelessComponentPlacerItem item, Player player,
                             ItemMenuHostLocator locator,
                             BiConsumer<Player, ISubMenu> returnToMainMenu) {
        super(item, player, locator, returnToMainMenu);
        materials = new SupplierInternalInventory<>(new StackDependentSupplier<>(
                this::getItemStack, WirelessComponentPlacerItem::getMaterialInventory));
        cableFilter = new SupplierInternalInventory<>(new StackDependentSupplier<>(
                this::getItemStack, WirelessComponentPlacerItem::getCableFilterInventory));
        partFilter = new SupplierInternalInventory<>(new StackDependentSupplier<>(
                this::getItemStack, WirelessComponentPlacerItem::getPartFilterInventory));
    }
